...
if (!empty($_POST)) {
    $name = inputVerify($_POST["theque_name"]);
    ...
    if($isUploadSuccess){
        $db = Database::connect();
        $statement = $db->prepare("INSERT INTO theque (name, photo) VALUES (?, ?)");
        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Ajouter une thèque</li>
                </ol>
            </div>
        </header>
        <!-- /Topbar -->
                        ...
                        <div class="panel-body pn mt20">
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputStandard" class="col-lg-4 control-label">Nom de la thèque</label>
                                    <div class="col-lg-8">
                                        <div class="">
                                            <input type="text" id="inputStandard" class="form-control" name="theque_name" placeholder="Ecrivez ici ...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary pull-right" value="Créer une thèque">
                                </div>
                            </form>
                        </div>
                    </div>
