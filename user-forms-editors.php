...
$titre = $article = $image = $imageError = "";
...
if (!empty($_POST)) {
    ...
    if($isUploadSuccess){
        $db = Database::connect();
        $statement = $db->prepare("INSERT INTO actualites (title, article, photo) VALUES (?, ?, ?)");
        $statement->execute(array($titre, $article, $image));
        Database::disconnect();
                    ...
                    <header id="topbar" class="alt">
                        <div class="topbar-left">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-current-item">Editer un nouvel article</li>
                            </ol>
                        </div>
                    </header>
                    <!-- /Topbar -->
                            ...
                            <div class="panel">
                                <div class="panel-body pn">
                                    <form method="post" action="" enctype="multipart/form-data">
                                        <label>Entrez le titre de l'article</label><br>
                                        <input type="text" name="titre" required="" class="form-control">

                                        <br>

                                        <textarea id="markdown-editor" name="content" rows="10">Redigez le texte de l'article ici ...</textarea>

                                        <label>Choisissez une image: <input type="file" name="img_back" required=""></label>
                                        <?php echo $imageError; ?>
                                        <br>
