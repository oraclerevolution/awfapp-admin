...
if (!empty($_POST)) {
    ...
    $descr = inputVerify($_POST["tips_descr"]);
    $image = inputVerify($_FILES["image_back"]["name"]);

    $imagePath = './images/tips/' . basename($image);
    ...
    if($isUploadSuccess){
        $db = Database::connect();
        $statement = $db->prepare("INSERT INTO tips (name, description, image) VALUES (?, ?, ?)");
        $statement->execute(array($name, $descr, $image));
        Database::disconnect();
                ...
                <div class="col-md-12 pln">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body pn mt20">
                            <form class="form-horizontal" method="post" action="add-tips.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputStandard" class="col-lg-4 control-label">Nom du tips</label>
                                    <div class="col-lg-8">
                                        <div class="">
                                            <input type="text" id="inputStandard" class="form-control" name="tips_name" placeholder="Ecrivez ici ...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-4 control-label" for="textArea2">Petite description</label>
                                    <div class="col-lg-8">
                                        <div class="">
                                            <textarea class="form-control" id="textArea2" name="tips_descr" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-4 control-label" for="textArea2">Choisissez une image</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary pull-right" value="Créer un tips">
                                </div>
                            </form>
                        </div>
                    </div>
