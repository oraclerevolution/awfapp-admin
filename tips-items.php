...
{  $id = checkInput($_GET['id']);
    ...
    $db = Database::connect();
    $statement = $db->query('SELECT * FROM tips where id ='.$id);
...
<head>
    <!-- Meta and Title -->
    <meta charset="utf-8">
    <title>AWFAPP - Listes des cours</title>
                                        ...
                                        <table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $cours = $bdd->query('SELECT * FROM tips_item WHERE id_tips='.$_GET['id']);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="update_course.php?id=<?php echo $donnees['id']; ?>">
                                                            <button class="btn btn-warning">Modifier</button>
                                                        </a>
                                                        <a href="delete_course.php?id=<?php echo $donnees['id']; ?>">
                                                            <button class="btn btn-danger">Supprimer</button>
                                                        </a>
                                                        <a href="./cours/<?php echo $donnees['file_name']; ?>">
