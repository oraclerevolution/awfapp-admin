...
<head>
    <!-- Meta and Title -->
    <meta charset="utf-8">
    <title>AWFAPP - Listes des articles</title>
                    ...
                    <header id="topbar" class="alt">
                        <div class="topbar-left">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-current-item">Liste des articles</li>
                            </ol>
                        </div>
                    </header>
                    <!-- /Topbar -->
                                ...
                                <div class="panel-body pn mt20">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="va-m sorting_desc">Titre</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $actu = $bdd->query('SELECT * FROM actualites');
                                                    while ($donnees = $actu->fetch()) {
                                                ?>
                                                <tr>
                                                    <td><?php echo $donnees['title']; ?></td>
                                                    <td><?php echo $donnees['register_date']; ?></td>
                                                    <td>
                                                        <a href="update_article.php?id=<?php echo $donnees['id']; ?>">
                                                            <button class="btn btn-warning">Modifier</button>
                                                        </a>
                                                        <a href="delete_article.php?id=<?php echo $donnees['id']; ?>">
